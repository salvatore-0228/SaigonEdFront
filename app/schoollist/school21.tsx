...
export default function School21() {
                            ...
                            <div className="rounded-lg border-white-100 shadow-md p-6 dark:bg-gray-900 dark:text-white dark:border-white dark:border">
                                ...
                                <div className="flex items-center space-x-4 mb-3">
                                    <div className="w-[5dvw] rounded">
                                        <a href="#">
                                            <img src="/images/school logos/Lycée Français International Marguerite Duras.jpg" alt="no image" />
                                        </a>
                                    </div>
                                ...
                                <div style={{ marginBottom: "1rem", overflow: "auto", height: "20dvh" }} className="text-sm">
                                    ...
                                    <p style={{ marginBottom: "1rem", textAlign: "justify" }}>
                                        Lycée Francais International Marguerite Duras is a public institution approved by the French Ministry of Education.
                                    </p>
                                </div>

                                <div className="flex flex-row gap-1 text-2xl mb-3" style={{ borderBottom: "1px solid gray", paddingTop: "1rem", paddingBottom: "1rem" }}>
                                    <Link href="https://lfiduras.com/" passHref legacyBehavior>
                                    ...
                                    <Link href="https://www.youtube.com/channel/UCTdxoU8EpPi8liIlQNRHo9g" passHref legacyBehavior>
                                        <a target="_blank" rel="noopener noreferrer">
                                            <div>
                                    ...
                                    <Link href="  https://www.facebook.com/LFIMD/" passHref legacyBehavior>
                                        <a target="_blank" rel="noopener noreferrer">
                                            <div>
                                ...
                                <div className="grid grid-cols-1 gap-x-10 text-sm">
                                    <InfoRow label="Curriculum" value="British and French" isLink />
                                    <InfoRow label="Leaving qualifications" value="French Baccalaureate and Brevet" isLink />
                                    <InfoRow label="Age range" value="range: (3 to 18)" />
                                    <InfoRow label="Tuition" value="144,686,355 ₫ to 173,581,443 ₫" />
                                    <InfoRow label="Address" value="Route No11 - Long Binh District 9 Ho Chi Minh Ville, Vietnam" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex flex-col flex-1 gap-[1rem]" id="container">
                    ...
                    <div className="flex-1 flex lg:flex-row flex-col lg:gap-[1dvw] gap-[1rem]">
                        <div className="w-full lg:w-1/2 overflow-hidden" id="slideheight">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3915.2173900419834!2d106.82253511525905!3d10.870870379318876!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3174df560dbeaac5%3A0xe34f7da6db8dc272!2sLyc%C3%A9e%20Fran%C3%A7ais%20International%20Marguerite%20Duras!5e0!3m2!1sen!2s!4v1691049276000!5m2!1sen!2s"
                                width="100%"
                                height="100%"
                                loading="lazy"
                                allowFullScreen
    ...
    content: [
      {
        ...
        data: "Lycée Francais International Marguerite Duras is a public institution approved by the French Ministry of Education."
      }
    ]
  },
  {
    ...
    content: [
      {
        ...
        data: "Brevet des Colleges (DNB), General Baccalaureate"
      }
    ]
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        data: "Primary: 14:00, Secondary: 16:00"
      },
      {
        type: undefined,
    ...
    content: [
      {
        ...
        data: "Football field, gym, swimming pool"
      }
    ]
  }
];
