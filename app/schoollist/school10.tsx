            ...
            <div className="flex lg:flex-row flex-col gap-[2rem] h-full">
                            ...
                            <div className="rounded-lg border-white-100 shadow-md p-6 dark:bg-gray-900 dark:text-white dark:border-white dark:border">
                                ...
                                <div className="flex items-center space-x-4 mb-3">
                                    <div className="w-12 h-12 rounded">
                                        <a href="#">
                                            <img src="/images/school logos/International Schools of North America.png" alt="no image" />
                                        </a>
                                    </div>
                                ...
                                <div style={{ marginBottom: "1rem", overflow: "auto", height: "20dvh" }} className="text-sm">
                                    ...
                                    <p style={{ marginBottom: "1rem", textAlign: "justify" }}>
                                        SNA stands out as 1 of only 6 IB Continuum Schools in Vietnam, offering programs from Grade 1 to Grade 12. We emphasize 
                                        student-centered learning and holistic development, fostering well-rounded individuals.
                                    </p>
                                </div>

                                <div className="flex flex-row gap-1 text-2xl mb-3" style={{ borderBottom: "1px solid gray", paddingTop: "1rem", paddingBottom: "1rem" }}>
                                    <Link href=" https://sna.edu.vn/" passHref legacyBehavior>
                                    ...
                                    <Link href="https://www.youtube.com/user/SchoolsNorthAmerica" passHref legacyBehavior>
                                        <a target="_blank" rel="noopener noreferrer">
                                            <div>
                                    ...
                                    <Link href="https://www.facebook.com/snavietnam/" passHref legacyBehavior>
                                        <a target="_blank" rel="noopener noreferrer">
                                            <div>
                                    ...
                                    <Link href="https://www.linkedin.com/in/sna-international-school-of-north-america-babb60274" passHref legacyBehavior>
                                        <a target="_blank" rel="noopener noreferrer">
                                            <div>
                                    ...
                                    <Link href="https://www.instagram.com/snasaigonsouthcampus/" passHref legacyBehavior>
                                        <a target="_blank" rel="noopener noreferrer">
                                            <div>
                                ...
                                <div className="grid grid-cols-1 gap-x-10 text-sm">
                                    ...
                                    <InfoRow label="Tuition" value="514,560,000 ₫ to 843,470,000 ₫" />
                                    <InfoRow label="Address" value="Street 20, Him Lam Quarter, South Saigon, Binh Chanh District, HCMC, Vietnam" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex flex-col flex-1 gap-[1rem]" id="container">
                    <div className="">
                        ...
                        <iframe
                            src="https://www.youtube.com/embed/PnWKYhP5kIk"
                    ...
                    <div className="flex-1 flex lg:flex-row flex-col lg:gap-[1dvw] gap-[1rem]">
                        <div className="w-full lg:w-1/2 overflow-hidden" id="slideheight">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.984309086126!2d106.68523197578357!3d10.730715859709007!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752fa500747bdd%3A0xd27018f1aaf26a4f!2sInternational%20Schools%20of%20North%20America%20(SNA)!5e0!3m2!1sen!2s!4v1691842030045"
                                width="100%"
                                height="100%"
                                loading="lazy"
                                allowFullScreen
