...
export default function School23() {
                            ...
                            <div className="rounded-lg border-white-100 shadow-md p-6 dark:bg-gray-900 dark:text-white dark:border-white dark:border">
                                ...
                                <div className="flex items-center space-x-4 mb-3">
                                    <div className="w-12 h-12 rounded">
                                        <a href="#">
                                            <img src="/images/school logos/Wellspring Logo.png" alt="no image" />
                                        </a>
                                    </div>
                                ...
                                <div style={{ marginBottom: "1rem", overflow: "auto", height: "20dvh" }} className="text-sm">
                                    ...
                                    <p style={{ marginBottom: "1rem", textAlign: "justify" }}>
                                        Wellspring Saigon is the only international bilingual school that has received permission from Massachusetts Department of 
                                        Education to use their curriculum.
                                    </p>
                                </div>

                                <div className="flex flex-row gap-1 text-2xl mb-3" style={{ borderBottom: "1px solid gray", paddingTop: "1rem", paddingBottom: "1rem" }}>
                                    <Link href=" https://wellspring.edu.vn/" passHref legacyBehavior>
                                    ...
                                    <Link href="https://www.facebook.com/WellspringSaigon" passHref legacyBehavior>
                                        <a target="_blank" rel="noopener noreferrer">
                                            <div>
                                ...
                                <div className="grid grid-cols-1 gap-x-10 text-sm">
                                    <InfoRow label="Curriculum" value="American and Vietnamese" isLink />
                                    <InfoRow label="Leaving qualifications" value="SAT and TOEFL" isLink />
                                    <InfoRow label="Age range" value="range: (6 to 18)" />
                                    <InfoRow label="Tuition" value="238,500,000 ₫ to 409,500,000 ₫" />
                                    <InfoRow label="Address" value="92 Nguyen Huu Canh Street, Ward 22, Binh Thanh District, Ho Chi Minh City, Vietnam" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex flex-col flex-1 gap-[1rem]" id="container">
                    ...
                    <div className="flex-1 flex lg:flex-row flex-col lg:gap-[1dvw] gap-[1rem]">
                        <div className="w-full lg:w-1/2 overflow-hidden" id="slideheight">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.360159167277!2d106.7190377!3d10.7902431!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317528aaf0400ddf%3A0x52330c3ed0d1f173!2sWellspring%20International%20Bilingual%20Schools%20-%20Wellspring%20Saigon!5e0!3m2!1sen!2s!4v1691306714804!5m2!1sen!2s"
                                width="100%"
                                height="100%"
                                loading="lazy"
                                allowFullScreen
        ...
        content: [
            {
                ...
                data: "Wellspring Saigon is the only international bilingual school that has received permission from Massachusetts Department of Education to use their curriculum."
            },
            {
                type: undefined,
                subheading: "Teaching approach of the school",
                data: "Wellspring Saigon believes that each student is a unique individual who needs a safe, caring, and inspiring environment in which to discover themselves and to grow. Therefore, Wellspring created a broad and stimulating curriculum that is rigorous yet exciting to teach and to learn. Endorsed by Massachusetts Department of Education, United States, Wellspring Saigon is able to integrate the curriculum into the Ministry of Education and Training of Vietnam program to equip students with necessary skill set on their path of education as well as life."
            }
        ]
    },
    {
    ...
    },
    {
        ...
        content: [
            ...
            },
            {
                ...
                data: "English as a Second Language"
            }
        ]
    },
    {
        ...
        content: [
            {
                ...
                data: "Measures of Academic Progress (MAP) test, Test of English as a Foreign Language (TOEFL), Scholastic Assessment Test (SAT)"
            }
        ]
    },
    {
        ...
        content: [
            {
                ...
                data: "Engineering club, science club, STEM club, debate club, CLB DIY, yoga, reading, MC club, reporters club, English fun fun club, coding, community volunteer club, performing arts, ukulele, ping pong, organ, drama, photography, contemporary dance, baking, vocal club, beauty club, chess, karate, ballet, aerobics, basketball, badminton, soccer, swimming, cooking, fine art, math."
            },
            {
                type: undefined,
        ...
        content: [
            {
                ...
                data: "Play yard, indoor swimming pool, dance studio."
            }
        ]
    }
];
