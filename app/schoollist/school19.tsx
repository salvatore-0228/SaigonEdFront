...
export default function School19() {
                            ...
                            <div className="rounded-lg border-white-100 shadow-md p-6 dark:bg-gray-900 dark:text-white dark:border-white dark:border">
                                ...
                                <div className="flex items-center space-x-4 mb-3">
                                    <div className="w-[5dvw] rounded">
                                        <a href="#">
                                            <img src="/images/school logos/Singapore International School logo.png" alt="no image" />
                                        </a>
                                    </div>
                                ...
                                <div style={{ marginBottom: "1rem", overflow: "auto", height: "20dvh" }} className="text-sm">
                                    ...
                                    <p style={{ marginBottom: "1rem", textAlign: "justify" }}>
                                        Singapore International School @ Saigon South is a purpose built international school campus with modern facilities located 
                                        in close proximity to the Phu My Hung residential area. The school provides a well rounded education to both foreign and 
                                        Vietnamese students from Kindergarten to Grade 12.
                                    </p>
                                </div>

                                <div className="flex flex-row gap-1 text-2xl mb-3" style={{ borderBottom: "1px solid gray", paddingTop: "1rem", paddingBottom: "1rem" }}>
                                    <Link href=" https://saigonsouth.sis.edu.vn/" passHref legacyBehavior>
                                    ...
                                    <Link href="https://www.facebook.com/siskinderworld/" passHref legacyBehavior>
                                        <a target="_blank" rel="noopener noreferrer">
                                            <div>
                                ...
                                <div className="grid grid-cols-1 gap-x-10 text-sm">
                                    <InfoRow label="Curriculum" value="British and Singaporean" isLink />
                                    <InfoRow label="Leaving qualifications" value="IGCSE and A-Levels" isLink />
                                    <InfoRow label="Age range" value="range: (3 to 18)" />
                                    <InfoRow label="Tuition" value="280,615,000 ₫ to 626,014,000 ₫" />
                                    <InfoRow label="Address" value="No. 29, Road No. 3, Trung Son Residential Area, Hamlet 4, Binh Hung Ward, Binh Chanh District, Ho Chi Minh City Vietnam" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex flex-col flex-1 gap-[1rem]" id="container">
                    ...
                    <div className="flex-1 flex lg:flex-row flex-col lg:gap-[1dvw] gap-[1rem]">
                        <div className="w-full lg:w-1/2 overflow-hidden" id="slideheight">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3916.335561349965!2d106.67852121525973!3d10.728986079314612!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752fa4eaf6690f%3A0x4a6a7d27ceae9227!2sSingapore%20International%20School!5e0!3m2!1sen!2s!4v1691048500000!5m2!1sen!2s"
                                width="100%"
                                height="100%"
                                loading="lazy"
                                allowFullScreen
    ...
    content: [
      {
        ...
        data: "Singapore International School @ Saigon South is a purpose built international school campus with modern facilities located in close proximity to the Phu My Hung residential area. The school provides a well rounded education to both foreign and Vietnamese students from Kindergarten to Grade 12."
      },
      {
        type: undefined,
        subheading: "Teaching approach of the school",
        data: "The school's mission is to provide quality educational programmes in a creative and challenging learning environment, embracing innovative teaching pedagogies to empower every student to become a life-long learner."
      },
    ]
  },
  {
    ...
    content: [
      {
        ...
        data: "12 up to 25 for kindergarten classes depending on the age of the students. Primary and Secondary classes have a maximum class size of 25."
      },
    ]
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        data: "Depends on the subject and grade level."
      },
    ]
  },
  {
    ...
    content: [
      {
        ...
        data: "Vietnamese Language club, Chinese club, homework club, chess, martial arts, swimming, badminton, table tennis, volleyball, basketball, soccer, commercial street/hip hop dance, ukulele, drumming, readers' theater, choir, junior drama, choral verse, public speaking."
      },
      {
        type: undefined,
    ...
    content: [
      {
        ...
        data: "Multiple outdoor sports facilities and a covered swimming pool."
      },
    ]
  },
];
