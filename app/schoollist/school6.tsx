                            ...
                            <div className="rounded-lg border-white-100 shadow-md p-6 dark:bg-gray-900 dark:text-white dark:border-white dark:border">
                                ...
                                <div className="flex items-center space-x-4 mb-3">
                                    <div className="w-12 h-12 rounded">
                                        <a href="#">
                                            <img src="/images/school logos/EMASI International Bilingual Schools.png" alt="no image" />
                                        </a>
                                    </div>
                                ...
                                <div style={{ marginBottom: "1rem", overflow: "auto", height: "20dvh" }} className="text-sm">
                                    ...
                                    <p style={{ marginBottom: "1rem", textAlign: "justify" }}>
                                        EMASI is a group of top-class international bilingual schools with Cambridge and National programs, international facilities 
                                        and American teaching methods that focus on developing critical skills for work and life in the modern global world.
                                    </p>
                                    <p style={{ marginBottom: "1rem", textAlign: "justify" }}>
                                    </p>
                                </div>
                                ...
                                <div className="grid grid-cols-1 gap-x-10 text-sm">
                                    <InfoRow label="Curriculum" value="Vietnamese, American, British, IGCSE, and A-Levels" isLink />
                                    <InfoRow label="Leaving qualifications" value="IGCSE, A-Levels, and AP" isLink />
                                    <InfoRow label="Age range" value="range: (3 to 18)" />
                                    <InfoRow label="Tuition" value="144,900,000 ₫ to: 421,100,000 ₫" />
                                    <InfoRow label="Address" value="Nam Long Campus: Ages 3 to 18: Nam Long Residential Area, Tan Thuan Dong Ward, District 7, Ho Chi Minh City, Vietnam" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex flex-col flex-1 gap-[1rem]" id="container">
                    ...
                    <div className="flex-1 flex lg:flex-row flex-col lg:gap-[1dvw] gap-[1rem]">
                        <div className="w-full lg:w-1/2 overflow-hidden" id="slideheight">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3916.431948969795!2d106.711065!3d10.8424879!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317529481aeae3cd%3A0x46c06ed6d23fa8df!2sEMASI%20Van%20Phuc!5e0!3m2!1sen!2s!4v1691840083456"
                                width="100%"
                                height="100%"
                                loading="lazy"
                                allowFullScreen
...
const accordionData = [
    ...
    },
    {
        ...
        icon: <Building2 size={20} />,
        content: [
            { subheading: "Qualities and characteristics best defining the school: ", data: "" },
