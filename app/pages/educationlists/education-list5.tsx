...
const schools = [
  {
    name: 'Horizon International Bilingual School - Ho Chi Minh Campus',
    ...
    linkpage: 33,
    website: "https://www.horizon.edu.vn/",
    youtube: "https://www.youtube.com/channel/UCk6rNOkCozwQc9EC9ccff6g",
    facebook: "https://www.facebook.com/horizonofficial.vn/",
    linkedin: "https://www.linkedin.com/company/horizon-international-bilingual-school",
    instagram: "https://www.instagram.com/hibsofficial.vn/",
  },
  {
    name: 'Aurora International School of the Arts',
    ...
    qualifications: "IGCSE, A-Levels, and AP",
    linkpage: 34,
    website: "https://www.auroraschool.vn/",
    youtube: "",
    facebook: "https://www.facebook.com/auroraschoolvn",
    linkedin: "",
    instagram: "https://www.instagram.com/auroraintschool/",
  },
  {
    name: 'École Boule et Billes',
    ...
    qualifications: "IGCSE, A-Levels, and AP",
    linkpage: 35,
    website: "https://bouleetbilles.net/",
    youtube: "",
    facebook: "https://www.facebook.com/ecolebouleetbilles",
    linkedin: "",
    instagram: "https://www.instagram.com/ecole_boule_et_billes_/",
  },
  {
    name: 'Pennsylvania American International School',
    ...
    qualifications: "IGCSE, A-Levels, and AP",
    linkpage: 36,
    website: "https://pennschool.edu.vn/",
    youtube: "https://www.youtube.com/channel/UCjJBt3Om7fWrfBY0P_jK8aw",
  ...
  },
  {
    ...
    youtube: "https://www.youtube.com/channel/UCJSXwoASiTXxU-erS3sY5vw/featured",
    facebook: "https://www.facebook.com/profile.php",
    linkedin: "https://www.linkedin.com/company/theabcis/",
    instagram: "",
  },
  // {
  //   name: 'Royal School',
...
export default function EducationMainPage5() {
      ...
      <div className='flex lg:flex-row flex-col lg:gap-[2dvw] md:gap-[2dvw] gap-[1rem] h-full'>
        ...
        <div className='flex lg:flex-row flex-col lg:w-1/2 md:w-1/2 lg:gap-[1dvw] md:gap-[1dvw] gap-[1rem]'>
          ...
          <div className='lg:w-1/2 md:w-1/2 flex flex-col lg:gap-[1dvw] md:gap-[1dvw] gap-[1rem]'>
            ...
            <div className={`${styles.card} flex-1`} style={{visibility: "hidden"}}></div>
...
// function FlipCardZ() {
//   return (
//     <div className={`${anim.card} h-[50dvh] w-full`}>
//       <div className={`${anim.card__content} text-center relative p-20 transition-transform duration-1000 text-white font-bold`}>

//         <div className={`${anim.card__front} absolute top-0 bottom-0 right-0 left-0 p-8 bg-pink-600 flex items-center justify-center`}>
//           <div className='h-full w-full'>
//             <img src="/images/1.jpg" className='h-full w-full' alt="" />
//           </div>
//         </div>
//         <div className={`${anim.card__back} absolute top-0 bottom-0 right-0 left-0 p-8 bg-teal-500 flex items-center justify-center`}>
//           <div className='h-full w-full'>
//             <SchoolCard {...schools[4]} />
//           </div>
//         </div>
